          ...
          <div className={classes.container7BlockRight}>
            <div className={classes.container7BlockRightEl}>
              ...
              <span>
                ...
                hat. Die Sanierung umfasste praktisch alle Bereiche: vom Dach
                über die Fassade bis hin zu Elektrik, Sanitär, Fußböden und den
                kompletten Innenausbau – und wir sind mehr als zufrieden mit dem
                Ergebnis. Bereits in der Planungsphase fühlten wir uns sehr gut
                aufgehoben. Die Beratung war ausführlich, ehrlich und
                lösungsorientiert.
              </span>
              <span>Martin Heinemann</span>
            </div>
          </div>
        </div>
      </div>
