        ...
        <div className={classes.containerBlock2}>
          <div className={classes.containerBlockBottom}>
            <div className={classes.containerBlockBottomBlockLeft}>
              <img src="../images/footerLogo2.svg" />
              <span>Wir sind Ihr starker Partner rund um Ihr Bauprojekt und des Innendesigns,unterstützen Sie bei der Umsetzung Ihrer Ideen und machen Ihr Wunsch wahr.</span>
            </div>
