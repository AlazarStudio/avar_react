      ...
      <div className={classes.container3}>
        ...
        <div className={classes.container3Bottom}>
          <div className={classes.container3BottomEl}>
            ...
            <span>Wir legen großes Wert auf Qualität und möchten Ihnen dies durch unsere Handwerker beweisen.</span>
          </div>
          <div className={classes.container3BottomEl}>
            <img src="../images/" />
            <span>Schnell Und Zuverlässig</span>
            <span>Wir haben kein Interesse Ihr Bauprojekt in die Länge zu ziehen. Zeitnaher Beginn und schnelle Umsetzung ist das Ziel.</span>
          </div>
          <div className={classes.container3BottomEl}>
            <img src="../images/" />
