  ...
  return (
    <div className={classes.container5}>
      <div className={classes.container5Block}>
        ...
        <div className={classes.container5BlockGroup}>
          <div className={classes.container5BlockGroupEl}>
            <span>
              01. <span></span>
            </span>
            <span>Beratung</span>
          ...
          <div className={classes.container5BlockGroupEl}>
            ...
            <span>
              ...
              aufzubauen, welches Ihnen das Gefühlt bieten soll, als wären sie
              im Film.
            </span>
          </div>
          <div className={classes.container5BlockGroupEl}>
            ...
            <span>
              Bei der Fertigstellung erwartet unser Team Sie mit einem Glas Wein
              in Ihrem neuen Zuhause und wünscht Sie bald wieder als Kunde bei
              der AVAR begrüßen zu dürfen.
            </span>
          </div>
        </div>
      </div>
