      ...
      <div className={classes.container3}>
        <div className={classes.container3Block}>
          ...
          <div className={classes.container3BlockEl}>
            ...
            <span>
              Schauen Sie sich unserer abgeschlossenen Projekte an und
              überzeugen Sie sich selbst von unserer Qualität und
              Geschicklichkeit. Das Team AVAR ist nicht nur Ihre ideale Wahl im
              Bereich Handwerk, sondern auch ein guter Freund mit viel Erfahrung
              und Bereitschaft diese mit Ihnen zu teilen. Vereinbaren Sie
              zeitnah einen kostenlosen Beratungstermin.
            </span>
          </div>
          <div className={classes.container3BlockEl}>
            <span>06</span>
