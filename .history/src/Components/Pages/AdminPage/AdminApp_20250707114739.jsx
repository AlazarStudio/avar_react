...
import { CategoryList, CategoryEdit, CategoryCreate } from './resources/Category';
import { FeedbackList, FeedbackEdit, FeedbackCreate } from './resources/Feedback';
  ...
  return (
    <BrowserRouter>
      ...
      >
        ...
        <Resource name="feedback" list={FeedbackList} edit={FeedbackEdit} create={FeedbackCreate} />
