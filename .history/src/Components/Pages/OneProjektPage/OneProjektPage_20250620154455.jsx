...
import classes from './OneProjectPage.module.css';
...
export default function OneProjectPage() {
  ...
  return (
    <div className={classes.oneProjectPage}>
      ...
      <div className={classes.projectDetails}>
        ...
        {/* Здесь можно добавить дополнительные разделы, например, использованные технологии, команда и т. д. */}
      </div>
