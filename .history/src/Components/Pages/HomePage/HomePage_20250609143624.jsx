  ...
  return (
    <>
      <div className={classes.contaier}>
        ...
        {/*Container5*/}
        {/*Container6*/}
        <div className={classes.contaier6}>
          <div className={classes.contaier6Block}>
            <div className={classes.contaier6BlockTop}>
              <span>Unsere Ausgewahlten Projekte</span>
            </div>
            <div className={classes.contaier6BlockBottom}>
              <div className={classes.contaier6BlockBottomEl}>
                <img src="../images/" />
                <span>Strangsanierung In Kiel</span>
                <span>
                  Hier werden insgesamt 36 Bäder neu kommen. Dabei handelt es
                  sich umkostengünstige Bäder. Immer 7-10 Bäder pro Strang.
                </span>
              </div>
            </div>
          </div>
