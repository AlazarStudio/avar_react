          ...
          <div className={classes.container2Block}>
            ...
            <div className={classes.container2Right}>
                ...
                <div className={classes.modalOverlay}>
                  <div className={classes.modalContent}>
                    ...
                    >
                      ...
                      <g mask="url(#fillMask)" fill="black">
                        {/* ⬇️ СЮДА ВСТАВЛЕНО СОДЕРЖИМОЕ Vector.svg */}
                        <path d="M350.702 144.599L222.429 375.908L90.9891 144.599H150.394L222.429 272.597L294.464 144.599H350.702ZM222.429 0C99.6321 0 0 99.6321 0 222.429C0 345.226 99.6321 444.858 222.429 444.858C345.226 444.858 444.858 345.226 444.858 222.429C444.858 99.6321 345.226 0 222.429 0Z" />
                      </g>
                    </svg>
              ...
              <div className={classes.formBlock}>
                <h2>Erhalte Kostenlos Beratung</h2>
                <input
                  name="name"
                  placeholder="Name*"
                  value={formData.name}
