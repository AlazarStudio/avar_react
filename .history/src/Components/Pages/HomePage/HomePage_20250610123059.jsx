        ...
        <div className={classes.container6}>
          <div className={classes.container6Block}>
            ...
            <div className={classes.container6BlockBottom}>
              <div className={classes.container6BlockBottomSwiper}>
                <Swiper
                  ...
                  pagination={{
                    ...
                    renderBullet: (index, className) =>
                      `<span class="${className}" style="width:10px;height:10px;margin:-50px 50px;background:#ed5338;border-radius:50%;display:inline-block;"></span>`,
                  }}
                  // spaceBetween={30}
                  loop={true}
                  // navigation
