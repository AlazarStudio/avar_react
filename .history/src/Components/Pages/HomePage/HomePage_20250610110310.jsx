  ...
  return (
    <>
      <div className={classes.contaier}>
        ...
        {/*Container5*/}
        {/*Container6*/}
        <div className={classes.contanier6}>
          <div className={classes.contanier6Block}>
            <div className={classes.contanier6BlockTop}>
              <span>Unsere Ausgewahlten Projekte</span>
            </div>
            <div className={classes.contaier6BlockBottom}>
              <div className={classes.contannier6BlockBottom}>
                <Swiper
                  slidesPerView={3}
                  // spaceBetween={30}
                  loop={true}
