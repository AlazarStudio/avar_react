      ...
      <div className={classes.contaier}>
        ...
        <div className={classes.container2}>
          <div className={classes.container2Left}>
            ...
            <span>Gerne nehmen wir uns die Zeit mit Ihnen Ihr Bauvorhaben persönlich zubesprechen, Ideen für die Umsetzung zu liefern und Sie positiv zuüberzeugen.</span>
            <span></span>
          </div>
          <div className={classes.container2Right}></div>
        </div>
        {/*Container2*/}
        {/*Container*/}
        {/*Container*/}
