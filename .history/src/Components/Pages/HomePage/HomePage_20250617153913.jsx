        ...
        <div className={classes.container8}>
          <div className={classes.container8Block}>
            <div className={classes.container8BlockEl}>
              <span>“</span>
              <span>‘’Das Unternehmen AVAR hat unsere Bungalow Saniert und wir sind Begeistert. Klar hat es ein wenig die Tasche leer geräumt, aber so ist das halt bei einer Kernsanierung. Ich bedanke mich für eure Hilfe und werde euch definitiv weiterempfehlen’’
